...
<table border="0" cellSpacing="0" cellPadding="0" width="100%" bordercolor="#000000" style="font-family:'楷体';">
  <thead>
  <tr>
    <td width="100%" colspan="4" style="font-size: 32px;text-align:center;"><b style="letter-spacing: 30px;">借款单</b></td>
  </tr>
  ...
  <tr height="30" style="font-size: 15px;">
	<th style="BORDER-COLLAPSE: collapse;  BORDER-LEFT: 1px  groove; BORDER-TOP:1px  groove; BORDER-RIGHT: 0px groove;BORDER-BOTTOM: 1px  groove;" width="120">借款人部门</th>
	<th style="BORDER-COLLAPSE: collapse;  BORDER-LEFT: 1px  groove; BORDER-TOP:1px  groove; BORDER-RIGHT: 0px groove;BORDER-BOTTOM: 1px  groove;" width="100">借款人</th>
	...
	<th style="BORDER-COLLAPSE: collapse;  BORDER-LEFT: 1px  groove; BORDER-TOP:1px  groove; BORDER-RIGHT: 1px groove;BORDER-BOTTOM: 1px  groove;" width="100">借款金额</th>
  </tr>
  </thead>
  ...
  <tr height="160">
	...
	<td style="BORDER-COLLAPSE: collapse;  BORDER-LEFT: 1px  groove; BORDER-TOP:1px  groove; BORDER-RIGHT: 0px groove;BORDER-BOTTOM: 1px  groove;" width="100"><bwie:formalStaff var="djr" fsid="${jlr}"/>${djr.name}</td>
	...
	<td style="BORDER-COLLAPSE: collapse;  BORDER-LEFT: 1px  groove; BORDER-TOP:1px  groove; BORDER-RIGHT: 1px groove;BORDER-BOTTOM: 1px  groove;" width="100"><fmt:formatNumber value="${fyje }" pattern="##00.00#" /></td>
  </tr>
